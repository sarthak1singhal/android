package com.elysion.elysion.Profile;
...
import com.elysion.elysion.Settings.Setting_F;
...
import com.elysion.elysion.Profile.Liked_Videos.Liked_Video_F;
import com.elysion.elysion.Profile.UserVideos.UserVideo_F;
...
import com.elysion.elysion.Video_Recording.GalleryVideos.GalleryVideos_A;
...
public class Profile_Tab_F extends RootFragment implements View.OnClickListener  {
    ...
    public  TextView username,username2_txt,video_count_txt, bio;
    ...
    public View init(){
        ...
        username2_txt=view.findViewById(R.id.username);
...
///here
                ...
                if(user_info.optString("bio").length() <= 30 ) bio.setText(user_info.optString("bio")) ;
            else
            bio.setText(user_info.optString("bio").substring(0,30));
