...
import com.elysion.elysion.SegmentProgress.ProgressBarListener;
import com.elysion.elysion.SegmentProgress.SegmentedProgressBar;
import com.elysion.elysion.SimpleClasses.FileUtils;
...
import com.elysion.elysion.SoundLists.SoundList_Main_A;
import com.elysion.elysion.Video_Recording.GallerySelectedVideo.GallerySelectedVideo_A;
...
public class Video_Recoder_A extends AppCompatActivity implements View.OnClickListener {
    public static int VESDK_RESULT = 4;
...
//         Intent intent =new Intent(this,VideoEditorDemoActivity.class);
         startActivity(intent);
//       Uri t = Uri.parse(new File(Variables.outputfile2).toString());
